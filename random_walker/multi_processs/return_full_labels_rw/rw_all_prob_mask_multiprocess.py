...
from configs import *
from random_walker.utils.histogram_features_two import show_date_index_formatter
from random_walker.utils.neighbor import SpatialNeighbor
...
def process_single_subject(subject_image_marker):
    ...
    while region_result_RW.sum() <= REGION_SIZE_MAX:
        ...
        labels.append(region_result_RW.copy())
