...
def generate_atlas_top_index_half_brain(subject_index):
    ...
    for half_brain_index in range(len(LEFT_RIGHT_BRAIN_NAME)):
        ...
        for j in range(ATLAS_NUM):
            ...
            volume2 = all_202_image_data[..., all_laebls_exsit_atlas_data_index[j]]
        ...
        #                                         TOP_RANK))
        # for top_index in range(TOP_RANK):
        #     left_right_brain_label_data[..., top_index] = all_202_label_data[..., all_laebls_exsit_atlas_data_index[index[top_index]]]
        #     if (left_right_brain_label_data[..., top_index] == (half_brain_index + 1)).sum() <= 0 or \
        #         (left_right_brain_label_data[..., top_index] == (half_brain_index + 3)).sum() <= 0:
